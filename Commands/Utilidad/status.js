...
module.exports = {
    ...
    async execute(message, args, commandName, client, Discord) {
        ...
        lastRolesCreator = rolesCreateLogs.entries.first() ? rolesCreateLogs.entries.first().executor.username : "Nadie.";
        lastRolesDelete = rolesDeleteLogs.entries.first() ? rolesDeleteLogs.entries.first().executor.username : "Nadie.";
        lastChannelCreate = channelCreateLogs.entries.first() ? channelCreateLogs.entries.first().executor.username : "Nadie.";
        lastChannelDelete = channelDeleteLogs.entries.first() ? channelDeleteLogs.entries.first().executor.username : "Nadie.";
        lastBotJoin = botJoinedLogs.entries.first() ? botJoinedLogs.entries.first().target.username : "Ninguno.";
        lastBotOwnerJoin = botJoinedLogs.entries.first() ? botJoinedLogs.entries.first().executor.username : "Nadie.";
        lastKicker = kickedLogs.entries.first() ? kickedLogs.entries.first().executor.username : "Nadie.";
        lastBanner = bannedLogs.entries.first() ? bannedLogs.entries.first().executor.username : "Ninguno."; 
        lastBanned = bannedLogs.entries.first() ? bannedLogs.entries.first().target.username : "Ninguno.";
        lastKicked = kickedLogs.entries.first() ? kickedLogs.entries.first().target.username : "Nadie.";        
        if(!Mlicious) {
