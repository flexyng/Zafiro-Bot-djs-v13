...
module.exports = {
    ...
    async execute(message, args, commandName, client, Discord, prefix) {
        ...
        return message.reply({ content: `${emojis.volumenes} | \`Nuestro sistema actualmente se encuentra en proceso de crecimiento, reporta a un usuario con ${prefix}reportar\` `, allowedMentions: { repliedUser: false } });
    }
}
