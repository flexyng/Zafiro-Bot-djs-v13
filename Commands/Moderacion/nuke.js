            ...
            colector.on('collect', async i => {
                if(i.customId === "nukear") {
                    if(!message.channel.deletable) {
                        ...
                        const Embed = new MessageEmbed()
                        .setTitle("Información")
                        .setDescription(`${emojis.positivo} | \`El canal esta siendo nukeado...\``)
                        .setColor("BLUE")
                        await i.deferUpdate();
                        await i.editReply({ embeds: [Embed], components: [], allowedMentions: { repliedUser: false } });
                        message.channel.clone().then(c => {
                            ...
                            .setTitle("Información")
                            .setDescription(`${emojis.positivo} | \`El canal ha sido nukeado correctamente.\``)
                            .setColor("BLUE")
                    ...
                    const Embed = new MessageEmbed()
                        .setTitle("Información")
                        .setDescription(`${emojis.negativo} | \`El nuke ha sido detenido correctamente.\``)
                        .setColor("BLUE")
                        await i.deferUpdate();
                        await i.editReply({ embeds: [Embed], components: [], allowedMentions: { repliedUser: false } });
                }
