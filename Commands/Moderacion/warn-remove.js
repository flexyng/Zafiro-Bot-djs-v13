        ...
        if (findPerms?.allowed.includes(commandName) && !findPerms?.denied.includes(commandName)) {
            ...
            if (id === "all") {
                ...
                const Response = new MessageEmbed()
                    ...
                    .setDescription(`${emojis.positivo} | \`Eliminé correctamente todos los warns\``)
                    .setColor("BLUE")
                    .setTimestamp()
            ...
            if (!warn) {
                ...
                if (warn.guildId !== message.guild.id) {
                    ...
                    const Response = new MessageEmbed()
                        .setTitle("Información")
                        .setDescription(`${emojis.positivo} | \`Eliminé correctamente el warn\``)
                        .setColor("BLUE")
                        .setTimestamp()
            ...
            if (!warn) {
                const ErrorResponse = new MessageEmbed()
                    .setTitle("Información")
                    .setDescription(`${emojis.negativo} | \`El warn no existe en mi base de datos\``)
                    .setColor("BLUE")
                    .setTimestamp()
                msg.edit({ embeds: [ErrorResponse], allowedMentions: { repliedUser: false } });
            } else {
