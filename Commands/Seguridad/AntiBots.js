    ...
    async execute(message, args, commandName, client, Discord, prefix) {
        ...
        if (!antibots) {
            ...
            const Embed = new MessageEmbed()
                ...
                .setDescription(`${emojis.cargando} | \`¿Estás seguro de activar el Anti-Bots en este servidor?\``)
                .setColor("BLUE")
                .setTimestamp();
            ...
            const Embed = new MessageEmbed()
                .setTitle("Información")
                .setDescription(`${emojis.cargando} | \`¿Estás seguro de desactivar el Anti-Bots en este servidor?\``)
                .setColor("BLUE")
                .setTimestamp();
            const confirmacion = await message.reply({ embeds: [Embed], components: [row], allowedMentions: { repliedUser: false } });
            const filter = i => i.user.id === message.author.id;
