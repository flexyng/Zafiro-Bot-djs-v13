    ...
    async execute(message, args, commandName, client, Discord, prefix) {
        if(!message.member.permissions.has("MANAGE_GUILD")) {
            ...
            if(!Palabras) {
                ...
                .setDescription(`${emojis.cargando} | \`¿Estas seguro de activar el antipalabras en este servidor?\``)
                .setColor("BLUE")
                .setTimestamp()
                ...
                colector.on('collect', async i => {
                    if(i.customId === "si") {
                        ...
                        .setDescription(`${emojis.positivo} | \`Entendido, he activado el antipalabras, para configurarlo usa de nuevo ${prefix}anti-palabras\``)
                        .setColor("BLUE")
                        .setTimestamp()
                ...
                .addComponents(
                    ...
                    .setDescription(`${emojis.escudo_azul} - Menu de selección del modulo \`antipalabras\`, porfavor selecciona el boton para realizar la acción que desees. \n\n ${emojis.mas} - \`Añadir una palabra a la blacklist\`\n\n  ${emojis.menos} - \`Remover una palabra de la blacklist\`\n\n📜 - \`Lista de palabras blacklisteadas\` \n\n${emojis.negativo} - \`Desactivar antipalabras\` `)
                    .setColor("BLUE")
                    .setTimestamp()
